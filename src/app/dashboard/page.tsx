...
export default function DashboardPage() {
  ...
  // ก้าวรวมสะสมทั้งหมดของโครงการ (ภาพใหญ่หัวหน้า) — เฉพาะก้าวที่อนุมัติ ไม่นับซ้ำรายวัน
  ...
  // ผู้บันทึก: หาจาก ID ก่อน แล้วค่อยหาจากชื่อ (กันกรณีเก็บเป็นชื่อ-สกุล)
  ...
  // ── พุธนี้ไม่มีเชื่อม: สถานะของตนเอง ──
  ...
  return (
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="px-5 py-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">โปรไฟล์ · ชื่อ-สกุล · ตำแหน่ง · ส่วนราชการ</p>
              </div>
      ...
      {/* ── 3) พุธนี้ไม่มีเชื่อม: สถานะของตนเอง ── */}
      <GlassCard className="p-5 md:p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
          <div className="flex items-center gap-2.5">
