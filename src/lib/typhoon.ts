...
function buildPrompt(ctx: TyphoonPromptContext): { system: string; user: string } {
  ...
  const user =
    ...
    `3. step_count: อ่านเฉพาะยอดรวมหลักเท่านั้น\n` +
    `   - ถ้าเห็นหัวข้อ TOTAL แล้วมีเลขใหญ่ เช่น "9,009 steps" ใต้คำว่า TOTAL + "Yesterday" ให้ตอบ 9009 (ห้ามเอาค่าเฉลี่ย "10,734 steps" ข้างล่างใน Highlights)\n` +
    `   - ถ้าเห็นการ์ด "จำนวนก้าว\\n3,231\\n/6,000" ให้ตอบ 3231 ไม่ใช่ 6000 (6000 คือเป้าหมาย)\n` +
    `   - ถ้าเห็น "ก้าวเดิน\\n5,546" และ "จำนวนชั้นที่ขึ้น\\n1" ให้ตอบ 5546 ไม่ใช่ 1\n` +
    `   - ห้ามอ่าน "34 นาที" / "101 แคล" / "2.19 กม." / ยอดกิจกรรมย่อยข้างล่าง ("237 ก้าว" / "480 ก้าว")\n` +
    `   ตัวอย่าง: TOTAL 9,009 + Highlights 10,734 → ตอบ 9009, จำนวนก้าว 3,231/6,000 → ตอบ 3231\n` +
