...
function buildPrompt(ctx: TyphoonPromptContext): { system: string; user: string } {
  ...
  const user =
    ...
    `3. step_count: อ่านเฉพาะตัวเลขก้าวรวมหลักที่อยู่ใกล้คำว่า ก้าว/ก้าวเดิน/steps/จำนวนก้าว (เช่น ก้าวเดิน 4,579 หรือ 8,516 /6,000 หรือ 2,936 ก้าว → 8516/2936) ถอด comma ออก ถ้าไม่เห็นให้ null\n` +
    `   อย่าสับสนกับ kcal, km, นาที, ชั้น — เลือกเลขที่อยู่ใต้คำว่า "จำนวนก้าว" หรือข้างไอคอนเท้าเท่านั้น\n` +
